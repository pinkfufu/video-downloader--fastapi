  ...
  <section id="pricing" class="py-16 sm:py-20 bg-transparent" aria-labelledby="pricing-heading">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        <!-- 免费版 -->
        <div class="miku-card rounded-2xl border border-border p-7 flex flex-col">
          <div class="mb-6">
          ...
          <button
            ...
            :class="user ? 'bg-primary/10 cursor-default' : 'hover:bg-primary/10 cursor-pointer'"
        ...
        <!-- VIP 版 -->
        <div class="relative bg-gradient-to-br from-primary to-sky-500 rounded-2xl p-7 flex flex-col text-[#042a39] overflow-hidden">
          ...
          <div class="relative">
            <div class="mb-6">
              ...
              <p class="text-sm text-[#073244]/70">解锁全部功能，无限制使用</p>
            </div>
            <div class="mb-6">
              <span class="text-4xl font-bold">¥9.9</span>
              <span class="text-[#073244]/70 text-sm ml-1">/月</span>
              <span class="ml-2 text-xs bg-white/20 px-2 py-0.5 rounded-full">限时优惠</span>
            </div>
            <ul class="space-y-3 mb-8">
              <li v-for="item in vipPlan" :key="item" class="flex items-start gap-2.5 text-sm text-[#083046]/90">
            ...
            <button
              ...
              class="w-full h-11 rounded-full bg-[#042a39] text-primary text-sm font-semibold hover:bg-[#07384d] transition-colors shadow-lg cursor-pointer"
            >
