<template>
  <footer class="bg-[#081727]/85 border-t border-border-light py-8 backdrop-blur">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <!-- 底部关键词友好描述 -->
      <div class="text-center mb-6">
        <p class="text-sm text-text-secondary leading-relaxed max-w-3xl mx-auto">
          <strong>Miku 下载器</strong> — 初音主题免费视频下载器，支持
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <a href="/" class="flex items-center gap-2" title="Miku 下载器首页">
