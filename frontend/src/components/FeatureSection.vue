    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        <h2 id="features-heading" class="text-2xl sm:text-3xl font-bold text-text-primary mb-3">
          为什么选择 <span class="text-primary">Miku 下载器</span>
        </h2>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <article
          ...
          :key="feature.title"
          class="group miku-card rounded-2xl p-6 border border-border-light shadow-sm hover:shadow-md hover:border-primary/40 transition-all"
        >
