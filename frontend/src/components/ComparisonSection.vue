    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-12">
        ...
        <p class="text-text-secondary text-base max-w-xl mx-auto">
          一张表看清 Miku 下载器的核心优势，更新于 2026 年 3 月
        </p>
      </div>

      <div class="overflow-x-auto rounded-2xl border border-border-light shadow-sm miku-card">
        <table class="w-full text-sm">
          <thead>
            <tr class="bg-primary/10 text-text-primary">
              <th class="text-left px-5 py-3.5 font-semibold">功能对比</th>
              <th class="px-5 py-3.5 font-semibold text-primary">Miku 下载器</th>
              <th class="px-5 py-3.5 font-semibold">其他在线工具</th>
              <th class="px-5 py-3.5 font-semibold">桌面下载软件</th>
            </tr>
          </thead>
          <tbody class="bg-transparent">
            <tr v-for="(row, i) in rows" :key="row.feature" :class="i % 2 === 1 ? 'bg-primary/5' : ''">
