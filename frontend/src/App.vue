<template>
  <div class="min-h-screen flex flex-col bg-bg-main relative">
    <div class="pointer-events-none absolute inset-0 overflow-hidden">
      <div class="absolute -top-24 left-12 w-96 h-96 rounded-full bg-cyan-300/10 blur-3xl"></div>
      <div class="absolute top-1/3 -right-16 w-[30rem] h-[30rem] rounded-full bg-sky-300/10 blur-3xl"></div>
    </div>
    <AppHeader
      :user="currentUser"
    ...
    <main class="flex-1 relative z-10">
      ...
      />
      <!-- 视频信息 + AI 总结：左右双栏同屏布局 -->
      <section v-if="videoData" class="py-4 sm:py-6 bg-transparent">
